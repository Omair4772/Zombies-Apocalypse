...
namespace Orangedkeys.AlphabetFX
{
    public class Welcome_AlphabetFX : EditorWindow
    {
        ...
        [MenuItem("Tools/OrangedKeys/AlphabetFX_Pack/About ", false, 0)]
        public static void ShowWindow()
        {
            EditorWindow editorWindow = GetWindow(typeof(Welcome_AlphabetFX), false, " About ", true);
        ...
        private void OnGUI()
        {
            ...
            */
            ...
            // Add The Banner
            Texture2D welcomeImage = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/AlphabetFxPack/Resources/AlphabetFX_img.png", typeof(Texture2D));
            ...
            EditorGUILayout.LabelField("Have fun with ''AlphabetFX PACK'' !! \n", LargeTextStyle);
            EditorGUILayout.Space();
